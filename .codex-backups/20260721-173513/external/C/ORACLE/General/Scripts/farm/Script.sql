...
DROP TABLE seller_points CASCADE CONSTRAINTS;
...
DROP SEQUENCE seller_points_seq;
...
/* 1-11. 판매자 포인트
   판매자 번호는 주문의 농장 정보를 통해 확인하므로 별도 외래키를 걸지 않는다. */
...
WHERE table_name IN (
    ...
    'PAYMENTS', 'SELLER_POINTS', 'DELIVERIES', 'QNA', 'REVIEWS',
...
WHERE sequence_name IN (
    ...
    'PAYMENTS_SEQ', 'SELLER_POINTS_SEQ', 'DELIVERIES_SEQ',
    'QNA_SEQ', 'REVIEWS_SEQ',
