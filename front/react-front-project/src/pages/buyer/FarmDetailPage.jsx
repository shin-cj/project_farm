    ...
    const handleQnaSubmit = async (e) => {
        ...
        try {
            await axios.post('http://localhost:8080/api/qna', {
                ...
                questionTitle: qnaTitle,
                questionContent: qnaContent,
                isSecret: isSecret
            })
                ...
                <div className="product-detail-info">
                    ...
                    <div className="product-detail-quantity">
                        ...
                        <div className="product-detail-quantity-control">
                            ...
                            <input type="number" min="1" max={product.stockQuantity} value={quantity} onChange={(e) => setQuantity(e.target.value)} />
            ...
            {farm && (
                <section className="product-detail-farm-card">
                    ...
                    <div className="product-detail-farm-actions">
                        ...
                        <button
                            type="button"
                            className="product-detail-farm-qna-link"
                            onClick={() => {
                                if (!userid) { alert('로그인이 필요한 기능입니다.'); navigate('/login'); return; }
            ...
            {isOrderModalOpen && (
                <div className="product-order-modal-backdrop">
                    <div className="product-order-modal">
                        ...
                        <label>수량 <input type="number" min="1" max={product.stockQuantity} value={quantity} onChange={(e) => setQuantity(e.target.value)} /></label>
