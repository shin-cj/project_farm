...
import { SE_CODES, CATEGORY_CODES, ITEM_CODES, VARIETY_CODES, DISTRICT_CODES, MARKET_CODES, GRADE_CODES } from '../buyer/categoryData';
...
// 🌟 2. 전체 부류의 모든 품목을 하나의 리스트로 평탄화 (전체 품목 검색용)
...
function SellerPriceSearchPage() {
    ...
    const isMarketDisabled = availableMarkets.length <= 2;
