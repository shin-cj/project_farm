...
function LoginPage() {
  ...
  // 💡 e(event) 파라미터를 추가하여 새로고침을 방지합니다.
  const handleLogin = async (e) => {
    e.preventDefault();

    try {
      // 💡 'data.email'이 아니라 위에서 만든 state인 'email'을 사용합니다.
      ...
      // 💡 백엔드에서 보낸 에러 메시지를 안전하게 출력합니다.
      const errorMsg = error.response?.data || "로그인 중 에러가 발생했습니다.";
      alert(errorMsg);
    }
  };
