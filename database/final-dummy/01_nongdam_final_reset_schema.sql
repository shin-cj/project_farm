/* =========================================================
   농담(Nongdam) 최종 시연 DB 1단계: 구조 초기화 SQL
...
CREATE TABLE products (
    ...
    same_day_delivery VARCHAR2(1) DEFAULT 'N' NOT NULL,
                                               -- 당일배송 여부: Y, N
    ai_keyword_1 VARCHAR2(50),                 -- AI가 생성한 첫 번째 상품 키워드
    ai_keyword_2 VARCHAR2(50),                 -- AI가 생성한 두 번째 상품 키워드
    ai_keywords_generated_at DATE,             -- AI 키워드 생성 또는 재생성 시각
    created_at DATE DEFAULT SYSDATE NOT NULL, -- 생성 일시
    updated_at DATE DEFAULT SYSDATE NOT NULL, -- 수정 일시
...
/* PK 자동 번호 시퀀스 생성 */
/* PK 자동번호용 시퀀스를 생성합니다. roles는 고정 번호를 사용합니다. */
