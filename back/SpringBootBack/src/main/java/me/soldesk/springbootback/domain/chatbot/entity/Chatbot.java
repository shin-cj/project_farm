package me.soldesk.springbootback.domain.chatbot.entity;
...
/** chatbot 테이블의 한 행을 Java 객체로 표현하는 Entity(엔티티)입니다. */
...
public class Chatbot {
    ...
    @SequenceGenerator(name = "chatbot_seq_generator", sequenceName = "chatbot_seq", allocationSize = 1)
    // 새 데이터 저장 시 위 시퀀스로 PK 값을 자동 생성합니다.
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "chatbot_seq_generator")
    ...
    @Lob
    // Java 필드와 실제 DB 컬럼을 연결하고 NULL 허용 여부를 지정합니다.
    @Column(name = "obj1", nullable = true)
    private String obj1;
